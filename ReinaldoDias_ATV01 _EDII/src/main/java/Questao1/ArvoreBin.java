 ...
 */
    ...
    private nodeAr removerRecursivo(nodeAr<T> atual, T dado) {
        if (atual == null) {
            return null;
        }
        ...
        if (comparacao < 0) {
            ...
            nodeAr<T> sucessor = encontrarSucessor(atual.getDir());
            atual.setDado(sucessor.getDado());
            atual.setDir(removerRecursivo(atual.getDir(), sucessor.getDado()));
    ...
    private nodeAr encontrarSucessor(nodeAr<T> atual) {
